<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Literary.aspx.cs" Inherits="Literary" %>
            ...
            <form runat="server">
                ...
                <section id="cseevents" class="wrapper style5" style="background-image:url('Images/culturalback.jpg');background-size:100% 100%;">  
                    <div class="content">
				        ...
				        <div class="root"><a href="#">Literary</a><div class="arrow">&#5171;</div><b>Events</b></div>
				        <div class="event_box">
                            <div class="event_box">
				                <a id="pop" class="event" >
                                    <div class="event_info">
                                        ...
                                        <div class="event_info-back">
                                            <h3>General Quiz</h3>
                                            <script type="text/javascript" src="assets/js/literarypopup.js"></script>
                                        </div>
                                    </div>
                                </a>
                             </div>
